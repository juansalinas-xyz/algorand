...
A continuación, veremos cómo podemos interactuar con Algorand rápidamente con el SDK para JavaScript. Para lograr esto, construiremos un pequeño proyecto en node, ver [aquí](https://github.com/jmsalinas88/algorand/tree/main/intro-to-algorand).
